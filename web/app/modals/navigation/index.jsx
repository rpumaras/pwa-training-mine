        ...
        switch (type) {
            ...
            case LOCALE_NAV_ITEM:
                return (
                    <NavItemWithOnClick
                        {...props}
                        selected={props.options.locale === locale}
                        onClick={() => {
                            closeNavigation()
                            setNavigationPath('/')
                            changeLocale(props.options.locale)
                        }}
                    />
                )
            default:
                return (
                    <NavItem
                        {...props}
                        beforeContent={props.options && props.options.hasLogo && <NavItemIcon name="edit" />}
                        childIcon={<NavItemIcon name="chevron-right" />}
                        title={props.title ? props.title : supportedLanguages[locale]}
                    />
                )
        }
    }
