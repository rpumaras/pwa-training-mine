...
exports.notImplementedCommand = exports.stringToTitleCase = exports.isStandalone = exports.validateCCNumber = exports.validateCCExpiry = exports.validateFullName = exports.buildQueryString = exports.createTypedAction = exports.typecheck = exports.requestIdleCallback = exports.splitFullName = exports.getCookieValue = exports.makeQueryString = exports.getURL = exports.getPath = exports.stripEvent = undefined;
...
var makeQueryString = exports.makeQueryString = function makeQueryString(params) {
    if (typeof params === 'undefined' || (typeof params === 'undefined' ? 'undefined' : (0, _typeof3.default)(params)) !== 'object') {
        return '';
    }
...
var createTypedAction = exports.createTypedAction = function createTypedAction(description, type, key) {
    return (0, _reduxActions.createAction)(description, key ? function (payload) {
        return (0, _defineProperty3.default)({}, key, typecheck(type, payload));
    } : function (payload) {
...
var notImplementedCommand = exports.notImplementedCommand = function notImplementedCommand(args) {
    return function (dispatch) {
        // eslint-disable-line no-unused-vars
        throw new Error('Command should be overriden by scaffold.');
    };
};