...
test('correctly makes a request', () => {
    ...
    return buildRequest({
        ...
        .then(() => {
            ...
            expect(options.uri).toBe('https://test.mobify.com/api/projects/progressive-web-sdk-tests/builds/')
...
test('builds an error message for ECONNREFUSED', () => {
    Request.mockImplementation((options, callback) => {
    ...
    expect(Utils.fail.mock.calls[0][0].startsWith('Unable to connect to test.mobify.com.')).toBe(true)
})
