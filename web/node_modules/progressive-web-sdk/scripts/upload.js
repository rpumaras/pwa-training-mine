...
const DEFAULT_ORIGIN = 'cloud.mobify.com'
...
const upload = (options) => {
    const dataBufferPromise = Utils.buildObject(ARCHIVE, options.message)
        .then((buildObj) => {
...
const uploadBundle = (customOptions) => {
    ...
    return Utils.createBundle(options.buildDirectory, options.projectSlug, ARCHIVE)
        .then(() => Utils.exists(ARCHIVE))
        .then(upload.bind(null, options))
}
