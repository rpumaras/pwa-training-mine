...
exports.parseEventData = exports.Frame = exports.VALUE_IS_MOBIFY = exports.KEY_IS_MOBIFY = exports.DEFAULT_EVENTS = undefined;
...
var DEFAULT_EVENTS = exports.DEFAULT_EVENTS = {
...
var KEY_IS_MOBIFY = exports.KEY_IS_MOBIFY = 'isMobifyFrameBridge';
var VALUE_IS_MOBIFY = exports.VALUE_IS_MOBIFY = true;

var Frame = exports.Frame = function Frame(options) {
    this.isReady = false;
    this.listeners = {};
 ...
 */
var parseEventData = exports.parseEventData = function parseEventData(data) {
    if (typeof data !== 'string') {
        return false;
    }

    var parsedEventData = void 0;
 ...
 */
Frame.prototype._log = function (caller) {
    var _console;
    ...
    return this.options.debug ? (_console = console).info.apply(_console, [caller].concat(args)) : false;
};
...
Frame.prototype._eventReceived = function (condition, event) {
    ...
    var listeners = this.listeners[eventData.eventName];
    if (listeners) {
        for (var ctr = 0; ctr < listeners.length; ctr++) {
...
Frame.prototype._sendMessage = function (windowObject, eventName, data) {
    ...
    var payload = (0, _defineProperty3.default)({
        eventName: eventName,
        data: data
    }, KEY_IS_MOBIFY, VALUE_IS_MOBIFY);

    windowObject.postMessage((0, _stringify2.default)(payload), this.options.origin);
};
...
Frame.prototype.off = function (event, callback) {
    ...
    var eventListeners = this.listeners[event] || /* istanbul ignore next */[];
