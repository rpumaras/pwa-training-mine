...
exports.isMessagingSupported = exports.shouldAsk = exports.isSubscribedToChannel = undefined;
 ...
 */
var isSubscribedToChannel = exports.isSubscribedToChannel = function isSubscribedToChannel(isSubscribed, channels, channelName) {
...
var shouldAsk = exports.shouldAsk = function shouldAsk(logger, _ref, alreadyShown) {
    var showOnPageCount = _ref.showOnPageCount,
        channelName = _ref.channelName,
        isSubscribed = _ref.isSubscribed,
        canSubscribe = _ref.canSubscribe,
        channels = _ref.channels,
        pageCount = _ref.pageCount,
        visitCountdowns = _ref.visitCountdowns;

    // If `showOnPageCount` is false, then we disable page counts as a guard
    var modulus = showOnPageCount ? pageCount % showOnPageCount : 0;
    var visitCountdown = visitCountdowns[channelName || _constants.DEFAULT_CHANNEL];
    var message = false;
    ...
    var channelMessage = channelName ? 'for channel ' + channelName : '';
 ...
 */
var isMessagingSupported = exports.isMessagingSupported = function isMessagingSupported() {
    var progressive = window.Progressive || {};
    var messaging = progressive.Messaging || {};
