...
if (FileUtils.existsSync(path.join('app', 'app-provider.jsx'))) {
    console.log('We have detected the routing file named \'app/app-provider.jsx\'. The SDK now requires that this file be named \'app/router.jsx\'')
    process.exit(1)
}
...
const scriptContents = fs.readFileSync(path.resolve(__dirname, '..', 'scripts', SCRIPT_FILENAME), 'utf8')
