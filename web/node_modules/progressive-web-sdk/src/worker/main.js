...
const worker = ({offlinePaths, precacheUrls = [], slug, isDebug}) => {
    ...
    toolbox.router.get(/cdn\.mobify\.com|localhost:8443/, toolbox.networkFirst, {cache: bundleCache})
    ...
    // Typekit fonts
    toolbox.router.get(/use\.typekit\.net\/[a-z0-9]+\.js/, toolbox.networkFirst, {cache: bundleCache})
