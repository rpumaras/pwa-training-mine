...
describe('getBuildOrigin', () => {
    ...
    test('stop building origin on furthur appended scripts', () => {
        ...
        const scriptEl2 = document.createElement('script')
        scriptEl2.src = 'https://f.monetate.net/?r=\'https://cdn.mobify.com/loader.js%26disabled%3D0%26domain%3D'
...
describe('getAssetUrl', () => {
    test('returns the path with base url and cache breaker if all provided', () => {
        expect(getAssetUrl('test.png', 'http://localhost:3333/', 'abcdef'))
            .toBe('http://localhost:3333/test.png?abcdef')
    })

    test('falls back to the build origin if no baseUrl is provided', () => {
        expect(getAssetUrl('test.png', null, 'fcdabe'))
            .toBe('//0.0.0.0:8443/test.png?fcdabe')
    })
...
describe('loadAsset', () => {
    test('loadAsset adds the specified type of node with the given options', () => {
        ...
        Object.keys(nodeAttributes).forEach((type) => {
            ...
            expect(nodes[1].src).toBe('placeholder.js')
