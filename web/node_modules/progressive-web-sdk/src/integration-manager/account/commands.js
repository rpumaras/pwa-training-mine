...
/* * *  *  * *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  * */
import {formSubmitErrorWrapper, dispatchWishlistAnalytics, dispatchCartAnalytics} from '../../analytics/actions'
 ...
 */
export const initAccountDashboardPage = (url, routeName) => connector.initAccountDashboardPage(url, routeName)
 ...
 * @param {string} routeName The route name of the current page
 */
export const initAccountOrderListPage = (url, routeName) => connector.initAccountOrderListPage(url, routeName)
 ...
 * @param {string} routeName The route name of the current page
 */
export const initAccountAddressPage = (url, routeName) => connector.initAccountAddressPage(url, routeName)
 ...
 * @param {string} routeName The route name of the current page
 */
export const initAccountViewOrderPage = (url, routeName) => connector.initAccountViewOrderPage(url, routeName)
...
export const addToCartFromWishlist = (productId, formValues) => (dispatch, getState) => {
    return dispatch(connector.addToCartFromWishlist(productId, formValues))
        .then((...args) => {
 ...
 */
export const removeItemFromWishlist = (itemID, wishlistID, productId, quantity) => (dispatch, getState) => {
    return dispatch(connector.removeItemFromWishlist(itemID, wishlistID, productId))
        .then((...args) => {
            dispatchWishlistAnalytics(EVENT_ACTION.removeFromWishlist, dispatch, getState, productId, quantity)
            return args
        })
}
 ...
 */
export const registerUser = (firstname, lastname, email, password, extraFields = {}) => connector.registerUser(firstname, lastname, email, password, extraFields)
 ...
 */
export const updateShippingAddress = (formValues) => formSubmitErrorWrapper(connector.updateShippingAddress(formValues))
 ...
 * @param {object} formValues The form values provided from the address form
 */
export const updateBillingAddress = (formValues) => formSubmitErrorWrapper(connector.updateBillingAddress(formValues))
