...
export const addItemToWishlist = (productId, productURL, quantity) => (dispatch, getState) => {
    return dispatch(connector.addItemToWishlist(productId, productURL, quantity))
        .then((...args) => {
            dispatchWishlistAnalytics(EVENT_ACTION.addToWishlist, dispatch, getState, productId, quantity)
            return args
        })
}
