...
describe('getDisplayName', () => {
    test('returns displayName if provided', () => {
        class AMockComponent extends React.Component { // eslint-disable-line react/prefer-stateless-function
            render() {
    ...
    test('returns name if provided', () => {
        class AnotherMockComponent extends React.Component { // eslint-disable-line react/prefer-stateless-function
            render() {
                return (<div>More mock html</div>)
            }
        }
