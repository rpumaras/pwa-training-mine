...
const ChildFrame = function(options) {
    ...
    this._isSameOrigin = (event) => event.origin === this.options.origin && event.source === this.parentWindow
...
ChildFrame.prototype._rpcHandler = function({uid, fnName, args}) {
    ...
    if (typeof fcn === 'undefined') {
        ...
        return Promise.resolve(fcn.apply(this, args))
            .then((res) => this.trigger(`${DEFAULT_EVENTS.RPC_CALL}:${uid}`, res))
    }
}
