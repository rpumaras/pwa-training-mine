...
const modalReducer = handleActions({
    ...
    [modalActions.closeModal]: (state, {payload: {modalName}}) => {
        ...
        return state
            .setIn([modalName, 'open'], false)
            .setIn([modalName, 'persistent'], false)
    },
    [modalActions.openPersistentModal]: (state, {payload: {modalName}}) => {
        return state
            .setIn([modalName, 'open'], true)
            .setIn([modalName, 'persistent'], true)
    },
    [modalActions.closeAllModals]: (state) => state.map((modal) => {
        return modal.set('open', false).set('persistent', false)
    }),
    [onRouteChanged]: (state) => state.map((modal) => {
