...
test('receiveProductDetailsProductData adds to the product map', () => {
    ...
    const productsState = reducer(initialState, results.receiveProductDetailsProductData({1: testProduct}))

    expect(selectors.getProductById('1')({products: productsState}).toJS()).toEqual(testProduct)
})
...
test('receiveProductListProductData adds to the product map without overriding values', () => {
    ...
    const productData = selectors.getProductById('1')({products: productsState}).toJS()
