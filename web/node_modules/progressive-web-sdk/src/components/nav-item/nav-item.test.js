...
test('renders extra content correctly', () => {
    ...
    expect(primaryWrapper.find('.pw-list-tile__content').childAt(0).type()).toBe('span')
    expect(primaryWrapper.find('.pw-list-tile__content').childAt(0).text()).toBe('override content')
})
