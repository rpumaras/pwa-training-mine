...
const defaultTriggerElement = <button><span>Share…</span></button>
const defaultShareContent = {title: document.title, url: window.location.href}
...
class Share extends React.Component {
    ...
    render() {
        ...
        const triggerComponent = React.cloneElement(triggerElement, {className: triggerClasses, onClick: this.onShow})
