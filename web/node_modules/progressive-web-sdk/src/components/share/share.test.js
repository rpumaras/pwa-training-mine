...
const testEmailShareUrls = (shareConfig, resultUrl) => {
    ...
    const wrapper = mount(<ShareSheetContent
    ...
    expect(JSON.stringify(props.onSuccess.mock.calls[0][0])).toBe(JSON.stringify({
        ...shareConfig,
        shareOption: 'email',
        url: resultUrl
    }))
...
describe('Share', () => {
    ...
    test('WebShare API calls onFail if it encounters an error', () => {
        ...
        // Wait for resolve
        setTimeout(() => { expect(props.onFail).toBeCalled() }, 100)
...
describe('ShareSheetContent', () => {
    ...
    test('calls onSuccess & onDismiss when copying succeeds', () => {
        const props = {
            ...Share.defaultProps,
            shareContent: {title: 'test title', url: 'test.com', text: 'test text', shareOption: 'copy'},
            onDismiss: jest.fn(),
            onSuccess: jest.fn(),
        }
        const wrapper = mount(<ShareSheetContent
    ...
    test('calls onSuccess & onDismiss when emailing and sharing succeeds', () => {
        ...
        const fbShare = {title: 'test title', url: 'test.com', text: 'test text', shareOption: 'facebook'}
        expect(JSON.stringify(props.onSuccess.mock.calls[0][0])).toBe(JSON.stringify({
            ...fbShare,
        ...
        const twShare = {title: 'test title', url: 'test.com', text: 'test text', shareOption: 'twitter'}
        expect(JSON.stringify(props.onSuccess.mock.calls[1][0])).toBe(JSON.stringify({
            ...twShare,
        ...
        const emailShare = {title: 'test title', url: 'test.com', text: 'test text', shareOption: 'email'}
        expect(JSON.stringify(props.onSuccess.mock.calls[2][0])).toBe(JSON.stringify({
            ...emailShare,
