...
const generateSharePages = ({shareOptions, optionsPerCol, optionsPerRow}) => {
    ...
    for (let i = 0; i < numShareOptionPages; i++) {
        ...
        // Fill columns
        for (let k = i * optionsPerPage; (k < shareOptions.length && k < (i + 1) * optionsPerPage) ; k++) {
...
class ShareSheetContent extends React.Component {
    constructor(props) {
        ...
        this.fbShareHandler = this.shareHandler.bind(this, {platform: 'facebook', successHandler, failHandler})
        this.twShareHandler = this.shareHandler.bind(this, {platform: 'twitter', successHandler, failHandler})
    }
    ...
    render() {
        ...
        const shareOptions = [
            {
                ...
                analyticsName: UI_NAME.shareCopy
            },
            {
                label: 'Email',
                iconName: 'email',
                ...
                analyticsName: UI_NAME.shareEmail
            },
            {
                label: 'Print',
                iconName: 'print',
                ...
                analyticsName: UI_NAME.sharePrint
            },
            {
                label: 'Facebook',
                ...
                analyticsName: UI_NAME.shareFacebook
            ...
            },
            {
                ...
                analyticsName: UI_NAME.shareTwitter
            }
        ]
        ...
        return (
            <div className={classes}>
                ...
                <textarea
                    readOnly={true}
                    ref={(self) => { this.textArea = self }}
                    style={{display: 'none'}}
                    value={shareContent.url}
                    data-analytics-name={UI_NAME.copy}
                />
            </div>
        )
    }
