...
class Carousel extends React.PureComponent {
    ...
    constructor(props) {
        ...
        this.eventHandlers = hasTouch() ? {
            onTouchStart: this.onDownHandler.bind(this),
            onTouchMove: this.onTouchMoveHandler.bind(this),
            onTouchEnd: this.onUpHandler.bind(this),
            onTouchCancel: this.onLeaveHandler.bind(this)
        } : {
            ...
            onMouseLeave: this.onLeaveHandler.bind(this)
        }
    }
    ...
    onUpHandler() {
        ...
        if (window.Progressive) {
            window.Progressive.analytics.send({
                subject: UI_SUBJECT.user,
                action: UI_ACTION.swipe,
                object: UI_OBJECT.element,
                name: UI_NAME.carousel,
                content: deltaX < 0 ? UI_NAME.next : UI_NAME.previous
            })
        }
    }
    ...
    onMoveHandler(e) {
        ...
        const deltaX = getCursorPosition(e.nativeEvent).x - dragStartX
        const deltaY = getCursorPosition(e.nativeEvent).y - dragStartY
    ...
    render() {
        ...
        const innerStyle = prefixAll(deltaX && animate && animationDuration
            ? {transform: `translate3d(${deltaX}px, 0, 0)`, transition: `transform ${duration.toString()}s ease-in-out`}
        ...
        return (
            <div className={classes}>
                <div className="pw-carousel__inner"
                    style={innerStyle}
                ...
                {showCaption &&
                    <span className={`pw-carousel__caption`}>
                    ...
                    <div className="pw-carousel__controls">
                        {showControls &&
                            <CarouselButton
                                ...
                                analyticsContent={UI_NAME.previous}
                            />
                        }
...
const defaultGetNextMessage = (nextIndex, total) => (
    `Show slide ${nextIndex} of ${total}`
)
