...
export const withPushMessaging = (WrappedComponent) => {
    class WithPushMessaging extends React.Component {
        ...
        accepted() {
            ...
            return this.props.subscribe(channels)
                .then((messagingState) => {
                    if (messagingState.subscribed) {
                        logger.forceLog(`Subscribed ${this.props.channelName ? `to channel ${this.props.channelName}` : ''}`)
...
const _withPushMessaging = (WrappedComponent) => {
    return connect(mapStateToProps, mapDispatchToProps)(withPushMessaging(WrappedComponent))
}
