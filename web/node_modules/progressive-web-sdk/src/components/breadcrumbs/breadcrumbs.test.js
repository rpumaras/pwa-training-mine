...
describe('When including microdata', () => {
    ...
    test('props passed correctly when includeMicroData set true', () => {
        const wrapper = shallow(<Breadcrumbs items={[{text: 'test'}]} className={name} includeMicroData={true} />)

        expect(wrapper.find('.pw-breadcrumbs__list').props().itemType).toBe('http://schema.org/BreadcrumbList')
    })
})
