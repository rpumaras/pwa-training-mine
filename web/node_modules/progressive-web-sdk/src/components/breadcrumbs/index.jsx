...
const Breadcrumbs = ({
    ...
    return (
        <nav role="navigation" className={classNames('pw-breadcrumbs', className)}>
            ...
            <ol aria-labelledby="breadcrumb__label" className="pw-breadcrumbs__list" {...breadcrumbListMicroData} >
                {items.map(({href, text, onClick}, index) => {
                    const itemContent = includeMicroData ?
                        (<span itemProp="name">{text} <meta itemProp="url" content={href} /></span>)
                        :
                        text
                    return (
