...
test('invokes onBack callback', () => {
    ...
    wrapper.find('Button.pw-nav-header__back').simulate('click', new MouseEvent('click', {bubbles: true, cancelable: true}))
...
test('invokes onClose callback', () => {
    ...
    wrapper.find('Button.pw-nav-header__close').simulate('click', new MouseEvent('click', {bubbles: true, cancelable: true}))
    expect(spy).toBeCalled()
})
...
test('invokes onTitleClick callback', () => {
    ...
    wrapper.find('.pw-nav-header__title').simulate('click', new MouseEvent('click', {bubbles: true, cancelable: true}))
    expect(spy).toBeCalled()
