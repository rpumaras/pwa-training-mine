...
describe('A NavMenu with NonExpandedItems', () => {
    const c1 = {title: '1', path: '/1/', key: '1', children: [
        {title: '3', path: '/1/3', key: '3'},
        {title: '4', path: '/1/4', key: '4'}
    ]}
    const c2 = {title: '2', path: '/2/', key: '2', children: [
        {title: '5', path: '/2/5', key: '5'},
        {title: '6', path: '/2/6', key: '6', children: [
            {title: '7', path: '/2/6/7', key: '7'},
        ]}
    ]}
    const root = {title: 'root', path: '/', children: [
        c1,
