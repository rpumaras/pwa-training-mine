...
class AccordionItem extends React.Component {
    ...
    render() {
        ...
        const classes = classNames('pw-accordion__item', {
        ...
        return (
            <div className={classes} id={this.itemId} ref={(el) => { this._container = el }}>
                <button className="pw-accordion__header"
                    ...
                    id={headerId}
                    type="button"
                    data-analytics-name={`${shown ? UI_NAME.collapse : UI_NAME.expand}_${UI_NAME.accordion}`}
                    ...
                    <div className={`pw-accordion__inner-header pw--icon-${iconPosition}`}>
                        <div className="pw-accordion__icon" aria-hidden="true">
                            <div className="pw-accordion__open-icon">
                                <Icon className="pw-accordion__glyph" size={iconSize} name={openIconName} />
                            </div>

                            <div className="pw-accordion__close-icon">
                                <Icon className="pw-accordion__glyph" size={iconSize} name={closeIconName} />
                            </div>
                        </div>

                        <div className="pw-accordion__title">
                            {header}
                        </div>
                    </div>
                </button>
