...
describe('Swatch', () => {
    ...
    test('passes the selected prop to the correct child', () => {
        ...
        const isItemSelected = (child) => wrapper.find('.pw-swatch__items')
            .childAt(child).props().selected
    ...
    test('selecting an option fires the onChange prop', () => {
        ...
        const wrapper = mount(<Swatch onChange={onChange}><SwatchItem value="25" /></Swatch>)
