...
class NestedNavigation extends React.Component {
    ...
    buildList(path) {
        ...
        if (!path || !list.items) { return (<List items={[]} />) }
    ...
    navigate(index) {
        ...
        if (index < 0) {
            ...
            if (!newList || !newList.items) { return }
    ...
    updateTitle() {
        ...
        if (title.position === POSITION_CENTER) { return }
    ...
    render() {
        ...
        const headerClassName = classNames('pw-nested-navigation__header c-nested-navigation__header', {
            'pw--is-root c--is-root': !path.length
        })
        const prevActionClass = classNames('pw-nested-navigation__prev-action c-nested-navigation__prev-action', {
            'pw--is-root c--is-root': !path.length
        })
            ...
            <div className={classes}>
                {header &&
                    <div className={headerClassName}>
                        ...
                        <div className="pw-nested-navigation__actions c-nested-navigation__actions">
                            {header.endActions && header.endActions.map((action, index) =>
                                <div
                                    className="pw-nested-navigation__action c-nested-navigation__action"
                                    key={index}
                                >
