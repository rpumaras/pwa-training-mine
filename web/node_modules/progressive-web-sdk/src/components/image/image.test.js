...
test('Image renders a loadingIndicator when passed', () => {
    const wrapper = mount(<Image src="http://www.url.com/does-not-exist.jpg" loadingIndicator={<div className="pw-test" />} />)

    expect(wrapper.find('.pw-test').length).toBe(1)
})

test('Image renders without the skeleton when hidePlaceholder is true', () => {
    const wrapper = mount(<Image src="http://www.url.com/does-not-exist.jpg" hidePlaceholder={true} />)
