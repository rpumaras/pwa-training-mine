...
test('Stateful Stepper accepts alternate button text', () => {
    ...
    const wrapper = mount(<Stepper name={STEPPER_NAME} incrementText={`${incrementText}`} decrementText={`${decrementText}`} />)
...
test('Redux Form Stepper accepts alternate button text', () => {
    ...
    const wrapper = mount(
        <Provider store={store}>
            <DecoratedStepper name={STEPPER_NAME} useReduxForm incrementText={`${incrementText}`} decrementText={`${decrementText}`} />
        </Provider>
    )
    const buttons = wrapper.find('Button')
...
test('Stateful Stepper can increment its value', () => {
    const wrapper = mount(<Stepper name={STEPPER_NAME} />)
    wrapper.find(incrementButtonClass)
        .simulate('click')
    wrapper.update()
...
test('Stepper can decrement its value', () => {
    ...
    wrapper.find(decrementButtonClass)
        .simulate('click')
