...
test('HeaderBarActions renders without errors', () => {
    const wrapper = mount(<HeaderBarActions><a href="/">Test</a></HeaderBarActions>)
    expect(wrapper.length).toBe(1)
})

test('HeaderBarActions includes the component class name with no className prop', () => {
    const wrapper = shallow(<HeaderBarActions><a href="/">Test</a></HeaderBarActions>)
...
test('HeaderBarActions renders the contents of the className prop if present', () => {
    [
        ...
        const wrapper = shallow(<HeaderBarActions className={name}><a href="/">Test</a></HeaderBarActions>)
...
test('HeaderBarActions renders a div with the given children', () => {
    const wrapper = shallow(<HeaderBarActions><span>a</span><div>b</div></HeaderBarActions>)
