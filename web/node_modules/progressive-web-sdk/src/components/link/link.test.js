...
test('errors out on invalid data props', () => {
    ...
    expect(Link.propTypes.data({data: dataProps}, 'data', 'Link'))
        .toEqual(new Error('Invalid prop data supplied to Link. Make sure it\'s an object with keys that start with \'data-\'. Validation failed.'))
})
