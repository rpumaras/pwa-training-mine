...
const ProgressStepsItem = (props) => {
    ...
    const classes = classNames('pw-progress-steps__item', {
        'pw--current': current,
    ...
    return (
        <li className={classes} style={styles}>
            <ProgressStepsStep className="pw-progress-steps__step" href={href}>
...
const defaultGetStepMessage = (stepIndex, total) => (
