...
test('LazyLoader renders without errors', () => {
    const wrapper = mount(<LazyLoader currentItemCount={1} fetchItems={emptyPromise}>test</LazyLoader>)
    expect(wrapper.length).toBe(1)
})

/* eslint-disable newline-per-chained-call */
test('includes the component class name with no className prop', () => {
    const wrapper = shallow(<LazyLoader currentItemCount={1} fetchItems={emptyPromise}>test</LazyLoader>)
...
test('renders the contents of the className prop if present', () => {
    [
        ...
        const wrapper = shallow(<LazyLoader currentItemCount={1} className={name} fetchItems={emptyPromise}>test</LazyLoader>)
...
test('adds scroll event listener on mount', () => {
    ...
    const wrapper = mount(<LazyLoader currentItemCount={1} className={name} fetchItems={emptyPromise}>test</LazyLoader>)
