...
class LazyLoader extends React.Component {
    ...
    handleScroll() {
        ...
        const bottomPosition = this.el.getBoundingClientRect().bottom
    ...
    render() {
        ...
        const loadMoreButtonClasses = classNames('pw-lazy-loader__load-more', loadMoreButtonClassName)
        ...
        return (
            ...
            >
                ...
                {loading &&
                    <div className="pw-lazy-loader__indicator">{loadingIndicator}</div>
                }
...
LazyLoader.propTypes = {
     ...
     */
    allItemsLoadedMessage: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.node
    ]),
     ...
     */
    loadMoreItemsMessage: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.node
    ]),
     ...
     */
    notificationAddedMessage: PropTypes.oneOfType([
        PropTypes.string,
        PropTypes.node
    ]),
