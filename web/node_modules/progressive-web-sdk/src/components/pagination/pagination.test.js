...
test('renders a previous button by default', () => {
    ...
    const wrapper = mount(<Pagination {...props} />)
    const prevButton = wrapper.children().children().filter(Button).first()
...
test('renders a next button by default', () => {
    ...
    const wrapper = mount(<Pagination {...props} />)
    const nextButton = wrapper.children().children().filter(Button).last()
...
test('renders a first button if specified', () => {
    ...
    const wrapper = mount(<Pagination {...props} />)
    const buttons = wrapper.children().children().filter(Button)
