...
class Pagination extends React.Component {
    ...
    renderPageButton(i) {
        ...
        return (
            <Button
                ...
                data-analytics-name={UI_NAME.pagination}
                data-analytics-content={`${UI_NAME.page} ${i}`}
            >
    ...
    render() {
        ...
        const classes = classNames('pw-pagination', {
        ...
        const Ellipsis = () => (
            <div className="pw-pagination__ellipsis">...</div>
        )
            ...
            <nav role="navigation" className={classes}>
                {firstButton &&
                    <Button
                        ...
                        disabled={atStart}
                        data-analytics-name={UI_NAME.pagination}
                        data-analytics-content={`${UI_NAME.page} 1`}
                        {...firstButton.props}
                ...
                {prevButton &&
                    <Button
                        ...
                        disabled={atStart}
                        data-analytics-name={UI_NAME.pagination}
                        data-analytics-content={UI_NAME.previous}
                        {...prevButton.props}
                ...
                <div className="pw-pagination__content">
                    ...
                    {showCurrentPageMessage &&
                        <span className="pw-pagination__page-count">{getCurrentPageMessage(currentPage, pageCount)}</span>
                    }
                </div>
                ...
                {nextButton &&
                    <Button
                        ...
                        disabled={atEnd}
                        data-analytics-name={UI_NAME.pagination}
                        data-analytics-content={UI_NAME.next}
                        {...nextButton.props}
                ...
                {lastButton &&
                    <Button
                        ...
                        disabled={atEnd}
                        data-analytics-name={UI_NAME.pagination}
                        data-analytics-content={`${UI_NAME.page} ${pageCount}`}
                        {...lastButton.props}
...
const defaultGetPageButtonMessage = (pageNumber) => (
    <span><span className="pw-pagination__hidden-label">Page </span>{pageNumber}</span>
)
