...
describe('LedgerRow', () => {
    test('renders without errors', () => {
        const wrapper = mount(<table><tbody><LedgerRow /></tbody></table>)
    ...
    test('renders the labelAction if present', () => {
        ...
        expect(wrapper.find('.pw-ledger__item').childAt(0).text()).toBe('LedgerRow')
        expect(wrapper.find('.pw-ledger__item .pw-ledger__action').children().get(0)).toEqual(labelAction)
    })
    ...
    test('renders the valueAction if present', () => {
        ...
        expect(wrapper.find('.pw-ledger__value').childAt(0).text()).toBe('¥1700')
        expect(wrapper.find('.pw-ledger__value .pw-ledger__action').children().get(0)).toEqual(valueAction)
    })
})
...
describe('Ledger', () => {
    ...
    test('includes its children as the children of the Ledger', () => {
        const wrapper = shallow(<Ledger><LedgerRow className="js-test" /></Ledger>)
