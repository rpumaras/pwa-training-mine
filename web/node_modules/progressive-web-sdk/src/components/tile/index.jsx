...
const Tile = ({
    ...
    const classes = classNames('pw-tile', {
        'pw--column': isColumn,
        'pw--full': isFull,
        'pw--simple': isSimple
    }, className)
        ...
        <article className={classes}>
            ...
            <div className="pw-tile__details">
                <div className="pw-tile__info">
                    ...
                    {ratingProps &&
                        <Rating {...ratingProps} className={classNames(`pw-tile__rating-stars`, ratingProps.className)} />
                    }
                </div>
                <div className={`pw-tile__footer`}>
                    <div className={`pw-tile__footer-inner`}>
                        <div className={`pw-tile__quantity`}>{quantityLabel}{quantity}</div>
