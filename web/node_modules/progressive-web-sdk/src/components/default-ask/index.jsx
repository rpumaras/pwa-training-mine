        ...
        return (
            ...
            >
                <div className="pw-push-messaging__default-ask-title u-flexbox">
                    <Icon name="alert" title={subscribeText} className="pw-push-messaging__default-ask-title-icon" />
                ...
                <div className="pw-push-messaging__default-ask-actions">
                    <Button className="pw-push-messaging__default-ask-actions-dismiss" onClick={this._dismissed}>
                        {dismissText}
                    </Button>
                    <Button className="pw-push-messaging__default-ask-actions-accept" onClick={this._accepted}>
                        {acceptText}
                    </Button>
                </div>
            </Sheet>
