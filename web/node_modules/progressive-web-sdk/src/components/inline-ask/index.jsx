...
export class InlineAsk extends React.Component {
    ...
    onOptIn() {
        if (this.props.canSubscribe) { // eslint-disable-line react/prop-types
            // Subscribe!
            ...
            <div className={classes}>
                ...
                {isSubscribed ?
                    <div className="pw-inline-ask__success">
                        <Icon name="check" title="Successfully subscribed" className="pw-inline-ask__success-icon" />
...
export default connect(mapStateToProps, mapDispatchToProps)(InlineAsk)
