...
describe('Analytics Manager', () => {
    ...
    test('initialize all supplied analytics connectors', () => {
        ...
        expect(scripts[0].src).toBe('//www.google-analytics.com/analytics.js')
        expect(scripts[1].src).toBe('/test.js')
    })
    ...
    test('turns on debug mode when #MOBIFY_DEBUG is in url', () => {
        ...
        const scripts = document.getElementsByTagName('script')
        expect(scripts[0].src).toBe('//www.google-analytics.com/analytics_debug.js')
    })
    ...
    test('console warns when data-analytics-name is not defined', () => {
        ...
        expect(window.console.error.mock.calls[1][0]).toBe('Element must have \'data-analytics-name\' attribute defined')
    })
