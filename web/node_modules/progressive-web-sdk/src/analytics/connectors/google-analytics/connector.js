...
export default class GoogleAnalytics extends Connector {
    constructor(displayName = 'Google Analytics', trackerName, options) {
        ...
        if (!trackerName) {
            throw new Error(
                `trackerName cannot be undefined`
            )
        }
        ...
        if (!(this.options.ecommerceLibrary === 'ec' || this.options.ecommerceLibrary === 'ecommerce')) {
            throw new Error(
                `"ecommerceLibrary" property must be either "ec" or "ecommerce"`
            )
        }
        ...
        const scriptSrc = '//www.google-analytics.com/analytics'
    ...
    ready(gaReadyCallback) {
        ...
        ga(() => {
            ...
            if (!this.tracker) {
                throw new Error(
                    `ready function should be overloaded with ga tracker creation`
                )
            }
    ...
    initEcommerceLib() {
        ...
        if ((!isECLoaded && !isEcommerceLoaded) ||
    ...
    purchaseEvent(payload) {
        ...
        if (this.isEC()) {
            ...
            this.send(EVENT_ACTION.purchase, ['ec:setAction', EVENT_ACTION.purchase, purchaseInfo.transaction])
            ...
            purchaseInfo.products.forEach((product) => {
                this.send(EVENT_ACTION.purchase, ['ecommerce:addItem', {
