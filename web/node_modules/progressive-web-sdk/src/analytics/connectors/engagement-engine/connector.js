...
export default class EngagementEngine extends Connector {
    ...
    performanceEvent(payload) {
        ...
        this.send(EVENT_ACTION.performance, createSandyPayload(EVENT_ACTION.performance, SANDY_TIMING_CATEGORY, metrics))
    }
    ...
    purchaseEvent(payload) {
        ...
        purchaseInfo.products.forEach((product) => {
            ...
            this.send(eventType, createSandyPayload(eventType, SANDY_ECOMMERCE_CATEGORY, {
                transaction_id: purchaseInfo.transaction.transaction_id,
                ...product
            }))
        })

        return createSandyPayload(EVENT_ACTION.purchase, SANDY_ECOMMERCE_CATEGORY, purchaseInfo.transaction)
    }
