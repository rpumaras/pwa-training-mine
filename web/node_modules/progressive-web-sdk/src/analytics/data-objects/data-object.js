...
export default class DataObject {
    constructor(requiredFields = [], acceptedFields = [], initialFields = {}, keepExtraFields = true) {
        ...
        Object.keys(initialFields).forEach((key) => {
            ...
            if (keepExtraFields || isValidKey) {
                this[key] = (typeof initialFields[key] !== 'undefined' && initialFields[key] !== null) ? initialFields[key].toString() : ''
    ...
    isValid(additionalRequiredFields = [], map = {}) {
        ...
        fieldsToCheck.forEach((field) => {
            ...
            if (!(this.hasOwnProperty(field) || (map[field] && map[field].hasOwnProperty('defaultValue')))) {
                throw new Error(
                    `${this.constructor.name} object must have '${field}' defined`
                )
            }
        })
    }
