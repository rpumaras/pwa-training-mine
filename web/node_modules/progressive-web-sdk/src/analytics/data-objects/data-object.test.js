...
class MyDataObject extends DataObject {
    static get REQUIREKEY1() { return 'requireKey1' }
    static get REQUIREKEY2() { return 'requireKey2' }
    static get ADDITIONALKEY1() { return 'additionalKey1' }
    static get ADDITIONALKEY2() { return 'additionalKey2' }
    static get ADDITIONALKEY3() { return 'additionalKey3' }

    constructor(fields, additionalRequiredFields, keyMap, keepExtraFields = false) {
        super([
            MyDataObject.REQUIREKEY1,
            MyDataObject.REQUIREKEY2
        ], [
            MyDataObject.ADDITIONALKEY1,
            MyDataObject.ADDITIONALKEY2,
            MyDataObject.ADDITIONALKEY3,
        ], fields, keepExtraFields)
