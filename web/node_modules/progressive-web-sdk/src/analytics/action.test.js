...
const getState = () => { return appState }
...
describe('Analytics Manager - Actions', () => {
    ...
    test('dispatch offline pageview analytics with offline_success', () => {
        expect(sendOfflinePageview('https://www.merlinspotions.com', 'test', 'test title', true)).toEqual({
    ...
    test('dispatch offline pageview analytics with offline_failed', () => {
        expect(sendOfflinePageview('https://www.merlinspotions.com', 'test', 'test title', false)).toEqual({
            type: 'Send offline pageview analytics',
            payload: 'https://www.merlinspotions.com',
            meta: {
                analytics: {
    ...
    test('dispatch offline mode used analytics', () => {
        ...
        expect(sendOfflineModeUsedAnalytics(duration, 1504050704103, [{inCache: true}, {inCache: false}, {inCache: false}])).toEqual({
