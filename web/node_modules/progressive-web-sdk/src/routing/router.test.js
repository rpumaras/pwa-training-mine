...
test('Router renders a ReactRouter', () => {
    const wrapper = shallow(<Router><Route path="/" /></Router>)
...
test('Router defaults to passing browserHistory as the history prop', () => {
    const wrapper = shallow(<Router><Route path="/test" /></Router>)
...
test('Router lets you override the history prop', () => {
    ...
    const wrapper = shallow(<Router history={fakeHistory}><Route path="/test" /></Router>)
...
test('Router sets a blacklist if defined', () => {
    ...
    shallow(<Router blacklist={blacklist}><Route path="/" /></Router>)
